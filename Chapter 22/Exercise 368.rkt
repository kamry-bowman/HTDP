...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname |Exercise 368|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
(define a0 '((initial "X")))
